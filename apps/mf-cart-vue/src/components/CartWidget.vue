...
const total = computed(() => products.value.slice(0, 2).reduce((sum, product) => sum + product.price, 0))
</script>
...
<template>
  <section class="cart-shell">
    ...
    <p class="body-copy">A Vue remote consumed by the React host without rewriting the shell.</p>
    <ul class="cart-list">
